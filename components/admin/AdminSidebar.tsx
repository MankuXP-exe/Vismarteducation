...
import {
  ...
  Video, Radio, Menu, X, PlusCircle, GraduationCap, FileVideo
} from "lucide-react";
...
const links = [
  ...
  { href: "/admin/recordings", label: "Recordings", icon: FileVideo },
  { href: "/admin/payments", label: "Payments", icon: CreditCard },
  { href: "/admin/vps", label: "VPS Monitor", icon: Monitor },
